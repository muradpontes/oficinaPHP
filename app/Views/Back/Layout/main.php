...
<head>
    ...
    <!-- Aqui é o espaço reservado para apresentar css específico das views que extendendem esse template -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo route_to('clients'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Murad</span>
                            </a>
    ...
    <!-- Aqui é o espaço reservado para scripts específico das views que extendendem esse template -->
